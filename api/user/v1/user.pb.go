...
// User is the wire representation.
//
// There is no password field, and there never will be. The omission is the
// guarantee: a hash cannot be serialised into a message that has nowhere to
// put it.
type User struct {
...
// Responses wrap the payload rather than returning User directly, so a field
// can be added later without changing the method signature.
...
const file_api_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x16api/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"{\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2\x92\x01\n" +
	"\vUserService\x12E\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponse\x12<\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseB5Z3github.com/DoIttikorn/e-commerce/api/user/v1;userv1b\x06proto3"
